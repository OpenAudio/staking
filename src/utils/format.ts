...
// Format bucket text for analytics time periods
// Re-export Bucket enum from analytics slice for convenience
import { Bucket as BucketEnum } from 'store/cache/analytics/slice'
export { Bucket } from 'store/cache/analytics/slice'

export const formatBucketText = (bucket: string): string => {
  const bucketMap: Record<string, string> = {
    [BucketEnum.ALL_TIME]: 'All Time',
    [BucketEnum.YEAR]: '1 Year',
    [BucketEnum.MONTH]: '1 Month',
    [BucketEnum.WEEK]: '1 Week',
    [BucketEnum.DAY]: '1 Day'
  }

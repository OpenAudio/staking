...
import OAPLogo from 'components/OAPLogo'
  ...
  return isMisconfigured ? (
    ...
    <HarmonyButton
      ...
      css={{
        ...
        boxShadow: '0 0 0 1px inset rgba(255, 255, 255, 0.2)',
        backgroundColor: 'transparent',
        color: '#ffffff',
        borderRadius: '8px',
        '&:hover': {
          backgroundColor: 'rgba(255, 255, 255, 0.1)',
          boxShadow: '0 0 0 1px inset rgba(255, 255, 255, 0.3)'
        }
      }}
    >
  ...
  return (
    <div className={styles.appBar}>
      <div className={styles.left}>
        <OAPLogo className={styles.logo} color='#ffffff' />
        {isMobile ? null : (
          <Box
            h={spacing['2xl']}
            css={{
